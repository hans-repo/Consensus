...
spawnServer batchSize clientPid = spawnLocal $ do
    ...
    runServer (ServerConfig myPid serverPids (Signature (show randomGen)) timeoutTicks [clientPid]) (ServerState 0 0 [genesisBlockSingle] [genesisBlockSingle] 0 [] batchSize randomGen 0)
