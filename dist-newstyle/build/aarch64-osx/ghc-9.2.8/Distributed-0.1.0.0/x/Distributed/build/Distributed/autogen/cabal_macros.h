...
/* package Distributed-0.1.0.0 */
#ifndef VERSION_Distributed
#define VERSION_Distributed "0.1.0.0"
#endif /* VERSION_Distributed */
#ifndef MIN_VERSION_Distributed
#define MIN_VERSION_Distributed(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Distributed */
...
#define CURRENT_COMPONENT_ID "Distributed-0.1.0.0-inplace-Distributed"
