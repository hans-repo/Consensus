...
/* package Hotstuff-0.1.0.0 */
#ifndef VERSION_Hotstuff
#define VERSION_Hotstuff "0.1.0.0"
#endif /* VERSION_Hotstuff */
#ifndef MIN_VERSION_Hotstuff
#define MIN_VERSION_Hotstuff(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Hotstuff */
...
#define CURRENT_COMPONENT_ID "Hotstuff-0.1.0.0-inplace-Distributed"
